...
import styles from './BullaBranding.module.css';

export interface BullaBrandingProps {
  className?: string;
}

export const BullaBranding: React.FC<BullaBrandingProps> = ({ className = '' }) => {
  return (
    <main className={`${styles.shopPage} ${className}`}>
      <div className={styles.container}>
        <div className={styles.stamp}>
          ...
          <p className={styles.shopMark}>Branding</p>
        </div>

        <h1 className={styles.title}>בקרוב</h1>
        <p className={styles.subtitle}>
          הסטודיו למיתוג של בולה בדרך אליכם.
          <br />
